...
python scraper --user=@chengxihan1 --password=Shuaijerryshuai2448878048 --query="Jan 2020 (from:BurgerKing) until:2020-01-31 since:2020-01-01" -t 100

python scraper -t 3200 --user=@chengxihan1 --password=Shuaijerryshuai2448878048 -u realDonaldTrump
